    ...
    <tr key={row.id} >
                  ...
                  <td className='new'>
                     ...
                     ringValues.map(val => (
                       ...
                       {/* Кнопка с программным переходом */}
        {/* Или просто ссылка (альтернативный вариант) */}
        {/* <a href={`/generate-link/${row.id}`} title="Generer le lien">Générer le lien</a> */}
